...
L'utilisateur sélectionne deux personnages parmi quatre classes (Guerrier, Elfe, Sorcière, Nain),
lance un combat automatique dont le déroulé s'affiche en temps réel, et peut consulter
l'historique des combats précédents.
...
La base de données est hébergée sur O2Switch et est déjà configurée. Aucune action
n'est requise de votre côté — l'application s'y connecte automatiquement au démarrage.
